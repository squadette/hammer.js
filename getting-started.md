...
- [Browse the source on GitHub](https://github.com/squadette/hammer.js/tree/master/)
...
See the pages about the [`recognizeWith`]({{site.baseurl}}/recognize-with) and [`requireFailure`]({{site.baseurl}}/require-failure) for
more details.
